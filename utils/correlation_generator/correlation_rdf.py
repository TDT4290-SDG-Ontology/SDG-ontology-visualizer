...
def generate_correlation_rdf(cc):
    ...
    <owl:NamedIndividual rdf:about="http://www.semanticweb.org/aga/ontologies/2017/9/SDG#correlation.{cc}.{from_target}-{to_target}">
        ...
        <SDG:subgoalCorrelationCountry>{cc}</SDG:subgoalCorrelationCountry>
        <SDG:subgoalCorrelationFactor rdf:datatype="http://www.w3.org/2001/XMLSchema#decimal">{factor}</SDG:subgoalCorrelationFactor>
    </owl:NamedIndividual>
