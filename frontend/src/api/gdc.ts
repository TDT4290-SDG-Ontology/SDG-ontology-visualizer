    ...
    const data: any = await api.POST(
      ...
      { municipality, year }
    	...
    	try {
	    	...
	    	const indicators: Map<string, IndicatorScore> = new Map<string, IndicatorScore>(data.indicators);
	    	const indicatorsWithoutGoals: Map<string, IndicatorWithoutGoal> = new Map<string, IndicatorWithoutGoal>(data.indicatorsWithoutGoals);
